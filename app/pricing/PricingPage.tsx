...
export function PricingPage() {
  return <div className="pricing-page">
    <header className="pricing-header">
      ...
      <nav aria-label="Pricing navigation"><Link href="/#map">How it works</Link><Link href="/pricing" aria-current="page">Pricing</Link><Link className="pricing-header-cta" href="/register">Create account <span>↗</span></Link></nav>
    </header>
    ...
    <footer className="pricing-footer"><Link href="/" className="pricing-brand"><PawMark /><span>WILD<strong>◆</strong>KIND</span></Link><p>Warm science for the individual animal.</p><nav><Link href="/pricing">Pricing</Link><Link href="/#map">Methodology</Link><Link href="/register">Account</Link></nav><small>© 2026 WildKind · Snapshot v0.1 · Not veterinary advice</small></footer>
  </div>;
}
