...
function Header({ screen, setScreen, signedIn, initials }: { screen: Screen; setScreen: (s: Screen) => void; signedIn: boolean; initials: string }) {
  ...
  return (
    <header className="site-header">
      ...
      ) : <div className="header-public"><span className="header-note">Behavior, carefully observed.</span><Link href="/resources/pet-behavior-observation-checklist">Free checklist</Link><Link href="/sample-field-guide">Sample report</Link><Link href="/methodology">Methodology</Link><Link href="/pricing">Pricing</Link></div>}
