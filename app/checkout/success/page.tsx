...
export default async function CheckoutSuccessPage() {
  ...
  return <main className="payment-status-page"><section className={`payment-status-card ${unlocked ? "payment-complete" : "payment-error"}`}>
    ...
    <p>{unlocked ? "Your one-time sandbox purchase is confirmed. Detailed guidance is now available on this account." : "PayPal has not yet produced a completed entitlement for this account. Do not repeat payment unless the checkout page confirms it is safe."}</p>
