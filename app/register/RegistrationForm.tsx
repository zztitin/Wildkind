...
export function RegistrationForm({ signInPath, userName }: { signInPath: string; userName: string | null }) {
  ...
  return <section className="registration-card">
    ...
    <p className="registration-intro">Continue with ChatGPT for secure, password-free sign-in. Your account starts private.</p>
    ...
    {ready ? <a className="registration-submit ready" href={signInPath}>Continue with ChatGPT <span>↗</span></a> : <button className="registration-submit" disabled>Confirm the required choices <span>↗</span></button>}
