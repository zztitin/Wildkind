  ...
  return (
    <div className="methodology-page">
      ...
      <footer className="methodology-site-footer">
        ...
        <nav><Link href="/resources/pet-behavior-observation-checklist">Free checklist</Link><Link href="/sample-field-guide">Sample report</Link><Link href="/methodology">Methodology</Link><Link href="/about">About</Link><Link href="/pricing">Pricing</Link><Link href="/register">Account</Link></nav>
